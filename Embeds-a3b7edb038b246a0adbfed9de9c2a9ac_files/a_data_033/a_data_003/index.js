...
function setup3DModel() {
  ...
  loader.load("assets/Skateboard.obj", function(object) {
    skateboard = object;
...
function update() {
  ...
  let skateboardGeometry = new THREE.Geometry().fromBufferGeometry(
    skateboard.children[0].geometry
  );
  ...
  for (
    var vertexIndex = 0;
    vertexIndex < skateboardGeometry.vertices.length;
    vertexIndex++
  ) {
